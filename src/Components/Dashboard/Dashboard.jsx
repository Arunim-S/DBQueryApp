        ...
        <>
            ...
            <div className="py-8 flex flex-col pr-4 gap-4 fixed z-[100] top-0 left-0 w-full h-full items-center justify-center bg-opacity-50 bg-black">
              <div className="h-1/2 w-1/2 flex p-8 flex-col justify-between bg-gray-300 rounded-2xl">
                <div className="flex w-full justify-between">
                  <h1 className="font-bold text-xl">Create Database</h1>
                  <button onClick={(e) => { setShowCreate(!showCreate) }}>
                    <svg
                ...
                <div className="gap-4 flex w-full items-center justify-center">
                  <label className="text-lg">Name</label>
                  <input type="text" value={name} className="p-2 outline-none rounded-xl w-full" onChange={(e) => { setName(e.target.value) }}></input>
                </div>
                <button className="bg-blue-400 rounded-xl h-10 w-32 mx-auto" onClick={(e) => handleCreateDB()}>Create</button>
          ...
          {showDelete ?
            <div className="py-8 flex flex-col pr-4 gap-4 fixed z-[100] top-0 left-0 w-full h-full items-center justify-center bg-opacity-50 bg-black">
              <div className="h-1/2 w-1/2 flex p-8 flex-col justify-between bg-gray-300 rounded-2xl">
                <div className="flex w-full justify-between">
                  <h1 className="font-bold text-xl">Delete Database</h1>
                  <button onClick={(e) => { setShowDelete(!showDelete) }}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="1.5rem"
                      height="1.5rem"
                ...
                <div className="gap-4 flex w-full items-center justify-center">
                  <label className="text-lg">Name</label>
                  <input type="text" value={deletedb} className="p-2 outline-none rounded-xl w-full" onChange={(e) => { setDeleteDb(e.target.value) }}></input>
                </div>
                <button className="bg-red-400  rounded-xl h-10 w-32 mx-auto" onClick={(e) => handleDeleteDB(deletedb)}>Delete</button>
                <div className="text-white">{responseMessage ? responseMessage : ""}</div>
              </div>
            </div> : ""
          }
