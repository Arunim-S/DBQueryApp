...
const Dashboard = () => {
  return (
    <div className="w-full flex h-screen">
      ...
      <div className="w-4/5 bg-black py-12">
        {/* search input */}
        ...
        {/* mid content */}
        <div className="w-full h-full flex-col items-center flex gap-8 justify-center">
          <h1 className="text-[#B0B0B0] mx-auto text-[3.5rem]">DB Query App</h1>
          <p className="text-[#B0B0B0] text-[2rem]">Start your day querying with natural language!</p>
        </div>
      </div>
    </div>
  );
