...
const Login = ({login, username}) => {
  ...
  return (
    <div className="bg-black opacity-[88%] w-full min-h-screen">
      {/* <Nav /> */}
      <Nav login={login} username={username} />
      <div className="flex flex-col pt-16 text-white gap-6 justify-center items-center">
        <p className="text-2xl">Sign up</p>
        <p className="text-xs text-center">Empower your experience with our DB Query Application.</p>
        <form onSubmit={handleSubmit} className="gap-4 text-black w-full max-w-lg mx-auto">
          <div className="mb-4">
          ...
          <div className="text-center gap-8 flex flex-col">
            ...
            <p className="text-lg text-center text-white">Already have an account? <span className="text-[#005AC9]">Login</span></p>
            <p className="text-center opacity-50 text-white">Or better yet...</p>
            <button
              type="submit"
